...
export default function NewBookPage() {
  ...
  const [chapters, setChapters] = useState<Chapter[]>([{ id: 1, title: "Chapter 1", duration: "", startTime: 0 }])
          ...
          <header className="border-b">
            <div className="container mx-auto px-4 py-4">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold">Add New Audiobook</h1>
              </div>
            </div>
          </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Enter the basic details of the audiobook</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Upload cover image and audio file</CardDescription>
                </CardHeader>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription>Add chapter information for better navigation</CardDescription>
                    </div>
              ...
              <div className="flex justify-end gap-4">
                ...
                <Button type="submit" disabled={loading || coverUploading || audioUploading}>
                  ...
                  {loading ? "Creating..." : coverUploading || audioUploading ? "Uploading files..." : "Create Book"}
                </Button>
              </div>
            </form>
          </main>
